...
`contribution guide  <https://github.com/australian-imaging-service/arcana/main/CONTRIBUTING.md>`_
for details.
...
add your name and affiliation to the `Zenodo file <https://github.com/australian-imaging-service/arcana/main/.zenodo.json>`_
