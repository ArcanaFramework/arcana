...
class DatasetMetadata(Metadata):
    ...
    generated_by: list[GeneratorMetadata] = attrs.field(
        converter=fromdict_converter(list[GeneratorMetadata])
    )
    acknowledgements: str = attrs.field(default="Generic BIDS dataset", repr=False)
    authors: list[str] = attrs.field(factory=list, repr=False)
    doi: str = attrs.field(default=None, repr=False)
    funding: list[str] = attrs.field(factory=list, repr=False)
    ...
    ethics_approvals: list[str] = attrs.field(factory=list)
    sources: list[SourceDatasetMetadata] = attrs.field(
