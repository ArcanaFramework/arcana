...
class Dataset:
    ...
    def __bytes_repr__(self, cache):
        ...
        yield bytes_repr_mapping_contents(self.columns, cache)
        yield bytes_repr_mapping_contents(self.pipelines, cache)
        yield bytes_repr_mapping_contents(self.analyses, cache)
