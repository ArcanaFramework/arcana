...
from arcana.core.utils import as_dict, from_dict


def test_dataset_as_dict_roundtrip(dataset):

    dct = as_dict(dataset, omit=['store'])
    undct = from_dict(dct, store=dataset.store)
