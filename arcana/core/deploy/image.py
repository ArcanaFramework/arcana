...
class ContainerImage:
    ...
    def create_metapackage(
        ...
        metapkg = cls(
            ...
            version=version,
            authors=[],
            info_url="https://arcana.readthedocs.io",
        )

        dockerfile = metapkg.init_dockerfile()

        metapkg.install_python(
            dockerfile, build_dir, use_local_packages=use_local_packages
        )

        metapkg.install_arcana(
        ...
        cls.build(dockerfile, build_dir, metapkg.tag)
