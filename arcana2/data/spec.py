...
class FileGroupSpec(FileGroupMixin, DataSpec):
    ...
    def __init__(self, path, format, tree_level=TreeLevel.session, desc=None,
                 namespace=None, salience=None, category=None,
                 converters=None):
        FileGroupMixin.__init__(self, path, format, tree_level, namespace)
...
class FieldSpec(FieldMixin, DataSpec):
    ...
    def __init__(self, path, dtype, tree_level=TreeLevel.session, array=False,
                 desc=None, namespace=None, salience=None, category=None):
        FieldMixin.__init__(self, path, dtype, tree_level, namespace,
                            array=array)
        DataSpec.__init__(self, desc, salience, category)
